...
const translations = {
  fr: {
    ...
    testimonial2: "Le cookie double chocolat du chapitre 3, c'est celui qui a tout changé. J'en ai fait 50 pour l'anniversaire de ma fille et tout le monde m'a demandé la recette. J'ai juste souri.",
    testimonialName2: "Aurélie M.",
    testimonialCity2: "Marseille",
    testimonial3: "J'ai vendu pour 180€ le premier week-end. Juste en postant une photo sur mon Instagram perso. Pas de pub, rien. Les gens voyaient la photo et voulaient commander.",
    testimonialName3: "Clara B.",
    testimonialCity3: "Toulouse",
    testimonial4: "Ce qui m'a bluffée c'est le guide des prix. Avant je vendais mes gâteaux à perte sans le savoir. Maintenant je facture correctement et mes clientes trouvent ça normal.",
    testimonialName4: "Nadia K.",
    testimonialCity4: "Bordeaux",
    testimonial5: "Ça faisait des mois que mes cookies étaient plats et secs. J'ai suivi la méthode à la lettre et le résultat était parfait dès la première fois. Franchement merci.",
    testimonialName5: "Lucie D.",
    testimonialCity5: "Nantes",
    testimonial6: "Je fais maintenant des commandes pour 3 bureaux dans mon quartier. Chaque lundi matin ils attendent leur boîte. C'est devenu mon petit business du week-end et j'adore ça.",
    testimonialName6: "Amandine V.",
    testimonialCity6: "Lille",
    testimonial7: "Simple, clair, efficace. Pas de blabla. Tu suis les étapes, ça marche. Point.",
    testimonialName7: "Yasmine R.",
    testimonialCity7: "Strasbourg",
    testimonial8: "Les recettes vegan m'ont surprise. Ma belle-sœur est intolérante au lactose et elle a pleuré tellement c'était bon. Pas de blague.",
    testimonialName8: "Margaux F.",
    testimonialCity8: "Nice",
    testimonial9: "J'ai offert une boîte à ma voisine pour la remercier d'un service. Le lendemain elle m'a commandé 3 boîtes pour son bureau. C'est comme ça que tout a commencé pour moi.",
    testimonialName9: "Céline P.",
    testimonialCity9: "Montpellier",
  ...
  de: {
    ...
    testimonial2: "Ich hab schon so viele Rezepte ausprobiert und war immer enttäuscht. Flache Kekse, harter Rand, kein cremiger Kern. Beim ersten Mal mit dieser Methode: perfekt. Ich konnte es kaum glauben.",
    testimonialName2: "Stefanie L.",
    testimonialCity2: "München",
    testimonial3: "Die Erdnussbutter-Cookies sind der absolute Wahnsinn. Meine Kolleginnen bestellen jetzt jede Woche eine Box fürs Büro.",
    testimonialName3: "Franziska H.",
    testimonialCity3: "Hamburg",
    ...
    testimonialName6: "Hannah B.",
    testimonialCity6: "Stuttgart",
    testimonial7: "Kurz und knapp: Rezepte funktionieren, Erklärungen sind klar, null Schnickschnack. Genau was ich gebraucht habe.",
    testimonialName7: "Christina M.",
    testimonialCity7: "Düsseldorf",
    testimonial8: "Meine Tochter ist vegan und ich wollte endlich Cookies machen, die ihr auch schmecken. Die vegane Sektion ist super — sie hat dreimal nachgenommen.",
    testimonialName8: "Petra R.",
    testimonialCity8: "Leipzig",
    testimonial9: "Hab die Cookies als Weihnachtsgeschenk für die Nachbarn gemacht. Im Januar hatte ich 8 Bestellungen. Jetzt ist es Februar und ich hab eine Warteliste. Verrückt.",
    testimonialName9: "Sabine D.",
    testimonialCity9: "Dresden",
  ...
  it: {
    ...
    testimonial2: "La ricetta con gocce di cioccolato fondente è diventata la mia firma. Ne faccio 40 ogni venerdì sera e il sabato sono già finiti. Il mio ragazzo dice che dovrei aprire un negozio.",
    testimonialName2: "Roberta C.",
    testimonialCity2: "Roma",
    testimonial3: "Guida pratica, zero fuffa. Leggi, fai, funziona. Punto.",
    testimonialName3: "Lucia M.",
    testimonialCity3: "Napoli",
    testimonial4: "Ho provato a vendere dolci per anni ma non riuscivo mai ad avere un prodotto costante. Con questo metodo, ogni lotto esce uguale. I clienti si fidano e ritornano.",
    testimonialName4: "Paola S.",
    testimonialCity4: "Torino",
    testimonial5: "Ero scettica. Un altro ebook, dai... Ma mia sorella me lo ha regalato e dopo il primo assaggio ho capito. Il segreto è nella tecnica di raffreddamento, non solo negli ingredienti.",
    testimonialName5: "Giorgia B.",
    testimonialCity5: "Firenze",
    testimonial6: "Ho fatto i cookies per il compleanno della mia collega in ufficio. Il lunedì dopo avevo 6 ordini. Adesso ne preparo ogni settimana per 3 uffici diversi nella mia zona.",
    testimonialName6: "Elisa P.",
    testimonialCity6: "Bologna",
    testimonial7: "La sezione sui prezzi mi ha aperto gli occhi. Vendevo a 1€ il pezzo pensando di essere cara. Ora vendo a 2.50€ e i clienti sono pure più contenti. Assurdo.",
    testimonialName7: "Antonella R.",
    testimonialCity7: "Palermo",
    testimonial8: "Mia figlia è celiaca e le ricette vegane si adattano benissimo anche senza glutine. Finalmente posso farle dei dolci che non sembrano \"la versione triste\" di quelli normali.",
    testimonialName8: "Monica V.",
    testimonialCity8: "Genova",
    testimonial9: "Ho iniziato due mesi fa per hobby. Ora ho un account Instagram dedicato, 400 follower e una lista di attesa. Non me lo aspettavo proprio.",
    testimonialName9: "Claudia D.",
    testimonialCity9: "Verona",
  ...
  nl: {
    ...
    testimonial2: "Ik bak al jaren maar kreeg nooit die dikke, zachte textuur voor elkaar. Na het lezen van hoofdstuk 2 snapte ik eindelijk wat ik fout deed. De eerste batch was meteen perfect.",
    testimonialName2: "Marieke B.",
    testimonialCity2: "Rotterdam",
    testimonial3: "De witte chocolade-frambozen cookie is echt een gamechanger. Daar krijg ik de meeste bestellingen op. Elke week minstens 3 dozen.",
    testimonialName3: "Femke D.",
    testimonialCity3: "Utrecht",
    testimonial4: "Ik had nul verwachtingen. Weer een ebook, dacht ik. Maar eerlijk? Dit is het beste bakboek dat ik heb, digitaal of niet. Super praktisch.",
    testimonialName4: "Roos M.",
    testimonialCity4: "Den Haag",
    testimonial5: "Begonnen als cadeautje voor kerst. Nu heb ik een wachtlijst en een eigen Instagram-pagina. In 6 weken tijd. Had ik echt niet zien aankomen.",
    testimonialName5: "Anouk K.",
    testimonialCity5: "Eindhoven",
    testimonial6: "De prijsgids was een eye-opener. Ik rekende veel te weinig. Nu vraag ik een eerlijke prijs en mijn klanten vinden het prima. Ze betalen graag voor kwaliteit.",
    testimonialName6: "Lieke W.",
    testimonialCity6: "Groningen",
    testimonial7: "Lekker recht door zee. Geen vaag gelul, gewoon: doe dit, dan dat, klaar. Precies mijn stijl.",
    testimonialName7: "Iris H.",
    testimonialCity7: "Tilburg",
    testimonial8: "Mijn dochter is lactose-intolerant. De vegan recepten zijn fantastisch — ze smaakte het verschil niet eens. Voor het eerst kon ze gewoon mee-eten.",
    testimonialName8: "Nienke P.",
    testimonialCity8: "Almere",
    testimonial9: "Ik verkoop nu elke zaterdag op de markt in Breda. Gemiddeld 90-150 euro per dag. Begonnen met een investering van 20 euro aan ingrediënten. Best een goede deal.",
    testimonialName9: "Eva R.",
    testimonialCity9: "Breda",
  ...
  pl: {
    ...
    testimonial2: "Przepis na cookie z białą czekoladą i malinami to mój hit. Robię je na zamówienie co piątek i w sobotę rano są już rozchwytane. Stałe klientki wracają co tydzień.",
    testimonialName2: "Weronika S.",
    testimonialCity2: "Kraków",
    testimonial3: "Konkretnie, bez lania wody. Robisz jak napisano i wychodzi. Koniec.",
    testimonialName3: "Dorota M.",
    testimonialCity3: "Wrocław",
    testimonial4: "Piekłam ciasteczka od lat i zawsze były płaskie. Myślałam, że to mój piekarnik. Okazuje się, że to technika schładzania ciasta. Jeden rozdział zmienił wszystko.",
    testimonialName4: "Beata W.",
    testimonialCity4: "Poznań",
    testimonial5: "Kupiłam z ciekawości, bo kosztowało mniej niż kawa z ciastkiem w kawiarni. Efekt? Teraz to ja sprzedaję ciastka do kawiarni. Serio.",
    testimonialName5: "Karolina P.",
    testimonialCity5: "Gdańsk",
    testimonial6: "Zaczęłam od zrobienia partii dla koleżanek z pracy. W poniedziałek miałam 5 zamówień. W następny piątek 12. Teraz piekę regularnie dla trzech biur w okolicy.",
    testimonialName6: "Justyna L.",
    testimonialCity6: "Łódź",
    testimonial7: "Przewodnik cenowy otworzył mi oczy. Sprzedawałam po 3 zł za sztukę i ledwo wychodziłam na zero. Teraz liczę po 6 zł i klientki nawet nie mrugnęły okiem. Moja marża się potroiła.",
    testimonialName7: "Aleksandra R.",
    testimonialCity7: "Katowice",
    testimonial8: "Moja córka jest na diecie wegańskiej i zawsze czuła się wykluczona z domowych wypieków. Sekcja wegańska jest genialna — zjadła cztery ciasteczka i powiedziała że to najlepsze jakie jadła.",
    testimonialName8: "Izabela B.",
    testimonialCity8: "Lublin",
    testimonial9: "Zrobiłam pudełka na Boże Narodzenie jako prezenty. W styczniu dostałam 11 zamówień od osób, które je próbowały. Nie planowałam tego, ale chyba mam teraz mały biznes.",
    testimonialName9: "Magdalena D.",
    testimonialCity9: "Szczecin",
